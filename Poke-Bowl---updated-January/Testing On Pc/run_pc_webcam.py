...
"""
PC Webcam Launcher
Runs the original Jetson project on PC using the built-in webcam
...
def run_system():
    """Run the original system with PC webcam configuration"""
    logger.info("=" * 60)
    logger.info("PC Webcam Mode - Inventory Vision System")
    logger.info("=" * 60)
